      ...
      <table>
		...
		<c:forEach items="${category}" var="category">
			...
			<tr>
                            ...
                            <sec:authorize access="hasRole('admin')"><td><a href="/fitshop/category/delete/${category.categoryId}">Delete</a></td></sec:authorize>
			</tr>
		</c:forEach>
                        <sec:authorize access="hasRole('admin')"><a href="/fitshop/category/newCategory">New</a></sec:authorize>
                        </tbody>
	</table>
